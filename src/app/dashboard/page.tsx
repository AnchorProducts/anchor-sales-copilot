      ...
      <div className="mx-auto max-w-6xl px-5 py-8">
        ...
        <div className="mb-6 flex flex-wrap items-center gap-2">
          ...
          <span className="text-[12px] text-[#76777B]">
            Clean layout • fast navigation • consistent brand
          </span>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          >
            ...
            <div className="mt-5 flex items-center justify-between">
              <div className="text-sm font-semibold text-[#047835]">
                Open Copilot <span className="transition group-hover:translate-x-1 inline-block">→</span>
              </div>
          ...
          >
            ...
            <div className="mt-5 flex items-center justify-between">
              <div className="text-sm font-semibold text-[#047835]">
                View Assets <span className="transition group-hover:translate-x-1 inline-block">→</span>
              </div>
        ...
        {/* Secondary section (optional but very “dashboard”) */}
